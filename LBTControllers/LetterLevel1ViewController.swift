...
class LetterLevel1ViewController: UIViewController {
    ...
    func setButtonLetters() {
        ...
        if button1.isCorrect! {
            button1.letter = alphabetItem.firstLetter
        ...
        if button2.isCorrect! {
            button2.letter = alphabetItem.firstLetter
        ...
        if button3.isCorrect! {
            button3.letter = alphabetItem.firstLetter
    ...
    func generateNewQuestion() {
        ...
        questionLabel.text = "\(alphabetItem.name) starts with what letter?"
